...
# Static dosyaları sun (logo + favicon)
...
async def root():
    ...
    <head>
        ...
        <style>
            ...
            body {
                margin:0; padding:0; height:100vh; background: linear-gradient(135deg, #0f0c29, #302b63, #24243e);
            ...
            h1 { font-family:'Orbitron',sans-serif; font-size:4.5rem; margin:0; background: linear-gradient(90deg,#00dbde,#fc00ff); -webkit-background-clip:text; -webkit-text-fill-color:transparent; }
            p { font-size:1.5rem; opacity:0.9; margin-top:20px; }
            .status { margin-top:40px; padding:12px 30px; background:rgba(0,255,136,0.15); border:1px solid #00ff88; border-radius:50px; font-weight:bold; color:#00ff88; }
