...
async def serve_dashboard():
    ...
    <head>
        <meta charset="UTF-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <title>Trading Dashboard - ICTSMARTPRO</title>
        <style>
            * { margin: 0; padding: 0; box-sizing: border-box; }
            body { 
                background: linear-gradient(135deg, #0a0f1a 0%, #0f1423 100%);
    ...
    <body>
        <div class="navbar">
            <h1 style="display: inline-block;">🚀 ICTSMARTPRO Trading Dashboard</h1>
        </div>
        ...
        <div class="container">
            <div class="card">
                ...
                <p style="color: #94a3b8; margin: 20px 0;">
                    The dashboard.html file is missing. Please ensure it exists in the project root.
                </p>
                <p style="color: #00d4ff; margin-bottom: 20px;">
                    API endpoints are still available at /api/analyze/{symbol}
                </p>
