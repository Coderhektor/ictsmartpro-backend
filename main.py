...
try:
    ...
    logger.warning("indicators.py bulunamadı. Sinyal üretimi fallback kullanacak.")
...
# ==================== EKSİK GLOBAL DEĞİŞKENLER (core.py'de yok, burada tanımla) ====================
...
async def analyze_chart(request: Request):
    try:
        ...
        analysis = "Sinyal sistemi aktif değil (indicators.py eksik)."
        if generate_ict_signal:
            analysis = "Gerçek ICT sinyal analizi çalışıyor."
