...
<body>
    <div class="container">
        ...
        <!-- CoinGecko Kayan Fiyat Terminali (Marquee) - Üst bantta -->
        <div style="margin-bottom: 30px;">
            <script async src="https://widgets.coingecko.com/coingecko-coin-price-marquee-widget.js"></script>
            <coingecko-coin-price-marquee-widget  coin-ids="bitcoin,ethereum,binancecoin,ripple,cardano,solana,polkadot,dogecoin,avalanche-2,chainlink,polygon,uniswap,litecoin,bitcoin-cash,stellar" currency="usd" background-color="#0a0e27" locale="en" font-color="#ffffff"></coingecko-coin-price-marquee-widget>
        </div>
